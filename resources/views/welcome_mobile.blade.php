    ...
    <header>
        <div id="navbar">
            ...
            <div id="hamburgermenu">
                ...
                <ul>
                    <li><a href="#news" class="smoothScroll link">{!! trans('messages.me_home') !!}</a></li>
					<li><a href="#news" class="smoothScroll link">{!! trans('messages.me_project') !!}</a></li>
					<li><a href="#news" class="smoothScroll link">{!! trans('messages.me_tokenomics') !!}</a></li>
					<li><a href="#news" class="smoothScroll link">{!! trans('messages.me_roadmap') !!}</a></li>
					<li><a href="#news" class="smoothScroll link">{!! trans('messages.me_team') !!}</a></li>
					<li><a href="#news" class="smoothScroll link">{!! trans('messages.me_news') !!}</a></li>
					<li><a href="#news" class="smoothScroll link">{!! trans('messages.me_whitepaper') !!}</a></li>
					<li>
			...
			<div class="home-visual">
				<ul class="home-visual-slider">
					...
					<li class="item-02">
						...
						<a href="{{$paper_link}}" class="section-btn-01 btn btn-default ">{!! trans('messages.ho_t_2_04') !!}</a>&nbsp;&nbsp;&nbsp;
					...
					<li class="item-03">
						...
						<a href="{{$paper_link}}" class="section-btn-01 btn btn-default ">{!! trans('messages.ho_t_3_04') !!}</a>&nbsp;&nbsp;&nbsp;
					...
					<li class="item-04">
						...
						<a href="{{$paper_link}}" class="section-btn-01 btn btn-default ">{!! trans('messages.ho_t_4_04') !!}</a>&nbsp;&nbsp;&nbsp;
					...
					<li class="item-05">
						...
						<a href="{{$paper_link}}" class="section-btn-01 btn btn-default ">{!! trans('messages.ho_t_5_04') !!}</a>&nbsp;&nbsp;&nbsp;
