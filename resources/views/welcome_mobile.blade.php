		...
		<section id="tokenomics" data-stellar-background-ratio="0.5" >
			...
			<div class="tokenomics-content" >
				...
				<div class="text-center" style="position:relative;">
					...
					<div class="wow fadeInLeft" data-wow-delay="0.2s" class="tokenomics_donut_graph_01">
					...
					<div  class="wow fadeInLeft" data-wow-delay="0.3s" class="tokenomics_donut_graph_01" style="">
					...
					<div  class="wow fadeInUp" data-wow-delay="0.4s" class="tokenomics_donut_graph_01" >
					...
					<div  class="wow fadeInUp" data-wow-delay="0.5s" class="tokenomics_donut_graph_01" >
					...
					<div  class="wow fadeInRight" data-wow-delay="0.6s" class="tokenomics_donut_graph_01" >
					...
					<div  class="wow fadeInRight" data-wow-delay="0.7s" class="tokenomics_donut_graph_01" >
