			...
			<div class="home-visual">
				<ul class="home-visual-slider">
					<li class="item-01">
						...
						<p class="s_txt_02 txt_type_02 txt_w">{!! trans('messages.ho_t_1_02') !!} {!! trans('messages.ho_t_1_02') !!}</p>
			...
			<div class="ourteam-content" >
				...
				<div class="row" >
					...
					<div class="col-xs-12 text-center wow fadeInUp " data-wow-delay="0.6s"  style="margin-bottom:30px">
						...
						<p class="txt_c_02">CLO of CHAINPLUS<br>Attorney at Law (NY, NJ) & C.P.A</p>
